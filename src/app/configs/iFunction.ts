export class iFunction {
  ...
  getUserInformation(): any {
    try {
      let strResult = this.getLocalStorage('USER_INFO');
      if (strResult) {
  ...
  getSystemDate(): any[] {
    try {
      let strResult = this.getLocalStorage('THANG_NAM_HT');
      if (strResult) {
        var json = JSON.parse(strResult);
      }
      return json;
  ...
  getSystemParam(): any[] {
    try {
      let strResult = this.getLocalStorage('THAM_SO_HT');
      if (strResult) {
        var json = JSON.parse(strResult);
      }
      return json;
  ...
  getMenuInfo(): any[] {
    try {
      let strResult = this.getLocalStorage('MENU_INFO');
